  ...
  return (
    <div className="loginPage">
        <div className="wallpage">
          <div className="text-white fw-semibold fs-4 ms-4 mt-2 goback" onClick={() => {navigate('/')}}>Quay về</div>
        </div>
      <div className="row justify-content-end">
        <div className="col-md-6 loginContainer">
          <div className={`loginContent ${!log ? 'd-none' : 'appear'}`}>
            <h2 className="mb-2">Đăng nhập</h2>
            <div className="mb-3 welcome">Chào mừng bạn trở lại với hệ thống vườn thông minh</div>
            <form>
              <div className="mb-3">
            ...
            <div className="text-center fw-semibold text-secondary">
                Bạn chưa có tài khoản? <span onClick={() => {setLog(!log)}} className="fw-semibold signUpNow">Đăng ký ngay</span>
            </div>
          </div>

          <div className={`signupContent ${log ? 'd-none' : 'appear'}`}>
            <h2 className="mb-2">Đăng ký</h2>
            <div className="mb-3 welcome">Chào mừng bạn đến với hệ thống vườn thông minh</div>
            <form>
              <div className="mb-3">
                <label for="username" className="form-label inputLabel">
                  Tài khoản
            ...
            <div className="text-center fw-semibold text-secondary">
                Bạn đã có tài khoản? <span onClick={() => {setLog(!log)}} className="fw-semibold signUpNow">Đăng nhập ngay</span>
            </div>
          </div>
        </div>
      </div>
